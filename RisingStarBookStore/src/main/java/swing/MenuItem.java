...
public class MenuItem extends javax.swing.JPanel {
    ...
    public MenuItem(final ModelMenu menu, final EventMenu event, final EventMenuSelected eventSelected, final int index) {
        initComponents();
        this.menu = menu;
        this.eventSelected = eventSelected;
        this.index = index;
        ...
        for (String st : menu.getSubMenu()) {
            final MenuButton item = new MenuButton(st);
