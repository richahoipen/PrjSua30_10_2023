...
public class PopupMenu extends javax.swing.JDialog {
    ...
    public PopupMenu(java.awt.Frame parent, final int index, final EventMenuSelected eventSelected, String... subMenu) {
        super(parent, false);
        initComponents();
        setOpacity(0f);
        ...
        for (String st : subMenu) {
            final MenuButton item = new MenuButton(st, true);
