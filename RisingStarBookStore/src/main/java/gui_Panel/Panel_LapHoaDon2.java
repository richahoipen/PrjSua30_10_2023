...
public class Panel_LapHoaDon2 extends JPanel {
			...
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addComponent(scr_DSCTHD, GroupLayout.DEFAULT_SIZE, 882, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
							.addGroup(layout.createParallelGroup(Alignment.TRAILING)
								.addGroup(Alignment.LEADING, layout.createSequentialGroup()
									.addGroup(layout.createParallelGroup(Alignment.LEADING)
										.addComponent(lbl_Title_ChonSanPham, GroupLayout.PREFERRED_SIZE, 176, GroupLayout.PREFERRED_SIZE)
										.addComponent(lbl_Title_DS_DD))
									.addGap(328))
								.addGroup(layout.createSequentialGroup()
									.addGroup(layout.createParallelGroup(Alignment.TRAILING)
										.addComponent(scr_DSDD, GroupLayout.DEFAULT_SIZE, 532, Short.MAX_VALUE)
										.addComponent(scr_DSSP, GroupLayout.DEFAULT_SIZE, 532, Short.MAX_VALUE))
									.addPreferredGap(ComponentPlacement.RELATED)))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(layout.createParallelGroup(Alignment.LEADING)
								.addComponent(lbl_Title_LapHoaDon, GroupLayout.PREFERRED_SIZE, 102, GroupLayout.PREFERRED_SIZE)
								.addComponent(pnLapHoaDon, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
				...
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(layout.createSequentialGroup()
							...
							.addGroup(layout.createParallelGroup(Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
									.addComponent(scr_DSDD, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(lbl_Title_ChonSanPham, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(scr_DSSP, GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
								.addComponent(pnLapHoaDon, GroupLayout.PREFERRED_SIZE, 227, Short.MAX_VALUE))))
					.addGap(8)
					.addComponent(lbl_Title_GioHang, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(scr_DSCTHD, GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
					.addContainerGap())
		);
						...
						.addGroup(gl_pnLapHoaDon.createSequentialGroup()
							.addGroup(gl_pnLapHoaDon.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_pnLapHoaDon.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED))
								.addComponent(lbl_TraKhachHang, GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE))
							.addGroup(gl_pnLapHoaDon.createParallelGroup(Alignment.LEADING)
								.addComponent(lbl_txt_TienThoi, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addComponent(txt_SoTienKhachTra, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addComponent(lbl_txt_TongTien, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addComponent(lbl_txt_SoDienThoai, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addComponent(lbl_txt_GioiTinh, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
								.addGroup(gl_pnLapHoaDon.createSequentialGroup()
								...
								.addComponent(lbl_txt_HoTenKhachHang, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE))
							.addContainerGap())
						.addGroup(gl_pnLapHoaDon.createSequentialGroup()
