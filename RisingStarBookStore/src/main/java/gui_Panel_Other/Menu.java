...
public class Menu extends PanelTransparent {
    ...
    private void initComponents(String maNV) {
        ...
        button = new JButton(new Custom_ImageIcon("src/main/images/view_image/Square.png",30,30));
        GroupLayout layout = new GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(sp, GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
            .addComponent(profile, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
            		.addComponent(button,GroupLayout.PREFERRED_SIZE, 40, 40)
                    .addComponent(employeeCard, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(sp, GroupLayout.DEFAULT_SIZE, 600, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup()
                		.addComponent(button, GroupLayout.DEFAULT_SIZE, 00, 40)
                		.addComponent(employeeCard, GroupLayout.DEFAULT_SIZE, 0, 30)
                ))
